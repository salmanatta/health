                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class=" col-6 mt-1">
                                    <label class="form-label" for="kinName">Pain Management </label>
                                ...
                                <div class="  col-6 mt-1">
                                    <label class="form-label" for="First-Name">Flexibility Exercies</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <div class="  col-6 mt-1">
                                    <label class="form-label" for="First-Name">Mobility (Distance/assistance/METs)</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <div class="  col-6 mt-1">
                                    <label class="form-label" for="First-Name">Stairs Training</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <div class="  col-6 mt-1">
                                    <label class="form-label" for="First-Name">Home Plane</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <div class="  col-6 mt-1">
